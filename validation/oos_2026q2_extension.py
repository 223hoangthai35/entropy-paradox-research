...
import validation.cross_market_v2 as cmv2
import validation.h2_eta_squared as h2e
import validation.link_b_tests as lbt
...
RESULTS_V2 = os.path.join(os.path.dirname(__file__), "results_v2")
...
def _load_dml_module():
    ...
    import validation.h1_dml_cpcv as h1c
