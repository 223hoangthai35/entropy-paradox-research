...
from validation.h2_magnitude.h2_eta_squared import compute_kw_h_and_eta
from validation.markets_n27 import CASCADE_N27
from validation.mechanism_battery.link_b_raw_sampen_test import cascade_point
from validation.out_of_sample.oos_2026q2_h2_alt_estimators import (
    aligned_arrays, bootstrap_eta, wls_slope, weighted_kendall, jonckheere,
)
from validation.mechanism_battery.rigor_composition_clr_eiv import clr
from validation.h2_magnitude.cross_market_v2 import _circular_block_indices
...
def main() -> int:
    ...
    from validation.h3_h4_h5.hysteresis_cross_market_v2 import _block_shuffle_p
